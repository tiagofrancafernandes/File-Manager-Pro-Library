...
const toggleShowMenu = (event) => {
    menuInfo.value.mobileShow = !menuInfo.value.mobileShow
}
</script>
    ...
    <header class="fixed w-full">
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            ...
            >
                ...
                <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end hidden">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <Link
                        :href="route('files.index')"
                        class="flex items-center gap-x-2 align-center text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800"
                    >
                        <svg
                            class="w-4 h-4"
                            fill="currentColor"
                    ...
                    <button
                        ...
                        aria-expanded="false"
                        v-on:click.capture.prevent="toggleShowMenu"
                    >
            ...
            <div class="max-w-screen-md mx-auto">
                ...
                >
                    ...
                    <h3 id="accordion-flush-heading-3">
                        ...
                        >
                            <span
                                >What are the differences between Landwind and
                                Tailwind UI?</span
                            >
                            <svg
                                data-accordion-icon
        ...
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">
                    ...
                    <a href="https://flowbite.com" class="text-purple-600 hover:underline dark:text-purple-500">Flowbite</a> and <a href="https://tailwindcss.com" class="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</a>.
                </span>
