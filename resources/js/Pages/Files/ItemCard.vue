    ...
    >
        ...
        <div class="w-full min-h-96 p-5">
            <div class="flex justify-between">
                <h2
                    class="w-10/12 text-xl font-medium text-gray-900 dark:text-gray-100"
                >
                    Sharing file
                </h2>
            ...
            <div class="w-full bg-gray-100 dark:bg-gray-700 my-2 rounded">
                <div class="p-2">
                    <h6 class="text-md text-gray-700 dark:text-white">
                        Share mode {{ shareMode }}
                    </h6>
                    <div class="flex gap-4 mb-4">
                        <div class="flex w-6/12 justify-start">
                            <div
                                class="flex justify-start items-center gap-x-0 p-3"
                            >
                                <input
                                    v-model="shareMode"
                                    type="radio"
                                    name="shareMode"
                                    value="url"
                                    :id="`${uid}share_mode_url`"
                                />
                                <label
                                    :for="`${uid}share_mode_url`"
                                    class="text-gray-700 dark:text-gray-200 cursor-pointer px-2 select-none"
                                >
                                    URL
                                </label>
                            </div>
                            ...
                            >
                                <input
                                    ...
                                    name="shareMode"
                                    value="embed"
                                    :id="`${uid}share_mode_embed`"
                                />
                                <label
                                    :for="`${uid}share_mode_embed`"
                                    class="text-gray-700 dark:text-gray-200 cursor-pointer px-2 select-none"
                                >
                                    Embed
                                </label>
                        ...
                        <div class="flex w-6/12 justify-end p-0">
                            <button
                                type="button"
                                v-on:click="openRenderedPdf(itemData)"
                    ...
                    <div class="flex flex-col gap-4 gap-y-1">
                        <div
                            class="flex w-full justify-end items-center gap-x-2"
                        >
                            <div class="w-full min-h-5 py-0">
                                <p
                                    v-if="copied"
                                    class="text-green-500 text-xs text-right m-0"
                                >
                                        ...
                                        >
                                            ...
                                            <li>
                                                <button
                                                    type="button"
                                                    @click.prevent="
                                                        openDownloadFileLink
                                                    "
                                                    class="flex w-full items-center justify-start gap-2 px-4 py-1 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                                                >
                                                    <svg
                                                        class="w-4 h-4"
                                                        xmlns="http://www.w3.org/2000/svg"
